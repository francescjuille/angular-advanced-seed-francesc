# Angular Seed Advanced created by Francesc Juille
...
All pages content are in src/app/pages folder. Each page has a substructure of 3 folders: components, containers and services, and a module and router-module for handle all page elements.
...
But an important think to clarify that is very important that this component is only used in this page and no more pages, if is not the case, you need to create this component in common/components.
...
src/app/common folder is for create all resources that 2 or more pages need to use (services, interfaces, components...)
